...
import com.beaconfire.dao.jdbc.AdminCourseDisplayDaoJdbcImpl;
...
public class AdminCourseService {
    ...
    @Autowired
    public void setDao(@Qualifier("adminCourseDisplayDaoJdbcImpl") AdminCourseDisplayDaoJdbcImpl adminCourseDisplayDaoJdbcImpl, @Qualifier("adminCourseDisplayDaoHibernateImpl") AdminCourseDisplayDaoHibernateImpl adminCourseDisplayDaoHibernateImpl, @Qualifier("ormSwitch") boolean ormSwitch) {
        this.adminCourseDisplayDao = ormSwitch ? adminCourseDisplayDaoHibernateImpl : adminCourseDisplayDaoJdbcImpl;
    }
