...
import com.beaconfire.dao.jdbc.StudentClassDaoJdbcImpl;
import com.beaconfire.dao.jdbc.StudentClassDisplayDaoJdbcImpl;
...
public class StudentClassService {
    ...
    @Autowired
    public void setStudentClassDisplayDao(@Qualifier("studentClassDisplayDaoJdbcImpl") StudentClassDisplayDaoJdbcImpl studentClassDisplayDao,
                                          @Qualifier("studentClassDisplayDaoHibernateImpl") StudentClassDisplayDaoHibernateImpl studentClassDisplayDaoHibernateImpl,
                                          @Qualifier("studentClassDaoJdbcImpl") StudentClassDaoJdbcImpl studentClassDao,
                                          @Qualifier("studentClassDaoHibernateImpl") StudentClassDao studentClassDaoHibernateImpl,
                                          @Qualifier("ormSwitch") boolean ormSwitch) {
        this.studentClassDisplayDao = ormSwitch ? studentClassDisplayDaoHibernateImpl : studentClassDisplayDao;
        this.studentClassDao = ormSwitch ? studentClassDaoHibernateImpl : studentClassDao;
    }
