...
import com.beaconfire.dao.jdbc.StudentDaoJdbcImpl;
...
public class StudentService {
    ...
    @Autowired
    public void setDao(@Qualifier("studentDaoJdbcImpl") StudentDaoJdbcImpl studentDaoJdbcImpl,
                       @Qualifier("studentDaoHibernateImpl") StudentDao studentDaoHibernateImpl,
                       @Qualifier("ormSwitch") boolean ormSwitch) {
        this.studentDao = ormSwitch ? studentDaoHibernateImpl : studentDaoJdbcImpl;
    }
